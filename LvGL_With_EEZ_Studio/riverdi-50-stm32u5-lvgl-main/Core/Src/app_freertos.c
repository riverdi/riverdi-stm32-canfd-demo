...
osThreadId_t UI_UpdateHandle;

const osThreadAttr_t UI_Update_attributes = {
  .name = "UI_Update",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 4* 1024
};
...
void MX_FREERTOS_Init(void) {
  ...
  UI_UpdateHandle=osThreadNew(UI_Update, NULL, &UI_Update_attributes);
